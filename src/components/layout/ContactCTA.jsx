...
const ContactCTA = () => {
  return (
    <section className="py-24 bg-emerald-950 relative overflow-hidden">
      {/* Hiệu ứng hạt sáng trang trí phía sau */}
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          {/* Headline lấy từ trang 10 Profile */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            {/* Nút chính */}
            <button className="w-full sm:w-auto bg-white text-emerald-950 hover:bg-emerald-50 px-10 py-5 rounded-2xl font-bold transition-all shadow-xl flex items-center justify-center group">
              Start Partnership
              <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={20} />
            </button>

            {/* Nút Hotline từ Profile */}
            <a 
              href="tel:0919636915" 
              className="w-full sm:w-auto border border-white/20 hover:border-white/50 bg-white/5 backdrop-blur-md text-white px-10 py-5 rounded-2xl font-bold transition-all flex items-center justify-center"
            >
          ...
          {/* Địa chỉ nhà máy để tăng độ tin cậy */}
